    ...
    public static class SeedInitialDataExtention
    {
        public static void SeedInitialData(this MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"INSERT INTO [dbo].[Users]
                                   ...
                                   ,[UserName])
                             VALUES
                                   ('3ad4f466-0f6d-411d-b0b4-fdf197505864'
		                           ,0         
                                   ,'60101ffb-556b-400a-afec-6702c3ba34f7'
                                   ,'test@test.test'
		                           ,0
		                           ,0       
                                   ,'FirstName'
            ...
            migrationBuilder.Sql(@"INSERT INTO [dbo].[Roles]
                                   ([Id]
                                   ,[ConcurrencyStamp]
                                   ,[Name]
                                   ,[NormalizedName])
                             VALUES
                                   ('4018C1C9-48DB-4EF1-AA88-246AEE5485BE'
                                   ,'C6115816-E4B6-4BFF-B43C-08C8105700BD'
                                   ,'Admin'
                                   ,'ADMIN'),
		                           ('DE048F59-C74E-4C33-ADAD-275F1A6592D2'
                                   ,'5C30CE26-F16E-4C20-97FC-B5A41F658AA6'
                                   ,'User'
                                   ,'USER')");

            migrationBuilder.Sql(@"INSERT INTO [dbo].[UserRoles]
                                   ([UserId]
                                   ,[RoleId])
                             VALUES
                                   ('3ad4f466-0f6d-411d-b0b4-fdf197505864'
