        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostalCode = table.Column<string>(maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcurrencyStamp = table.Column<string>(unicode: false, maxLength: 128, nullable: true),
                    Name = table.Column<string>(unicode: false, maxLength: 128, nullable: true),
                    NormalizedName = table.Column<string>(unicode: false, maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedEmail = table.Column<string>(unicode: false, maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Url = table.Column<string>(unicode: false, maxLength: 2048, nullable: true)
                },
                constraints: table =>
                {
